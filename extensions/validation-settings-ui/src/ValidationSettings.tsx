...
export default reactExtension(TARGET, async (api) => {
  console.log("validation settings api", api);
  ...
  console.log("validation settings configuration", configuration);
...
function ValidationSettings({ configuration, products }) {
  ...
  console.log("validation settings settings", settings);
  ...
  const onChange = async (variant, value) => {
    ...
    console.log("validation settings applyMetafieldChange result", result);
